...
export default function CallToAction() {
  ...
  return (
    <section id="contact" className="cta" style={{ position: 'relative', overflow: 'hidden' }}>
      {/* 3D Model representing Connection & Engagement */}
      <ThreeDCanvas
        archetype="torus"
        color="#ea580c"
      ...
      <div className="container cta__inner" style={{ position: 'relative', zIndex: 2 }}>
